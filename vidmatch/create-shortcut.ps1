# Creates a Windows shortcut (.lnk) that launches the vidmatch UI with no console window.
...
$uiScript  = Join-Path $scriptDir "vidmatch-ui.ps1"
$lnkPath   = Join-Path $scriptDir "vidmatch.lnk"
...
$shortcut.Description      = "vidmatch UI"
$shortcut.Save()

Write-Host "Shortcut created: $lnkPath"
Write-Host "Double-click vidmatch.lnk to launch the UI with no console window."
